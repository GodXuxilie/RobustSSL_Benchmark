...
nohup python finetuning_eval.py --gpu 2 --experiment DeACL_cifar10_r18_stl10 --dataset stl10 --pretraining DeACL --model r18 --checkpoint ./checkpoints/DeACL.pt --mode Ensemble --eval-AA --eval-OOD &
