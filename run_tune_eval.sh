...
nohup python finetuning_eval.py --gpu 2 --experiment DynACL_IR_plus_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL_IR_plus --model r18 --checkpoint ./checkpoints/DynACL_IR_plus.pt --mode ALL --eval-AA --eval-OOD &
...
nohup python finetuning_eval.py --gpu 2 --experiment DynACL_IR_plus_cifar100_r18_cifar100 --dataset cifar100 --pretraining DynACL_IR_plus --model r18 --checkpoint ./checkpoints/DynACL_IR_plus_CIFAR100.pt --mode ALL --eval-AA --eval-OOD &
...
nohup python finetuning_eval.py --gpu 2 --experiment DynACL_IR_plus_stl10_r18_stl10 --dataset stl10 --pretraining DynACL_IR_plus --model r18 --checkpoint ./checkpoints/DynACL_IR_plus_STL10.pt --mode ALL --eval-AA &
