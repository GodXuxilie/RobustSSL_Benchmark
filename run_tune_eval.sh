...
nohup python finetuning_eval.py --gpu 2 --experiment DynACL++_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL++ --model r18 --checkpoint ./checkpoints/DynACL++.pt --mode ALL --eval-AA --eval-OOD &
...
nohup python finetuning_eval.py --gpu 2 --experiment DynACL++_cifar100_r18_cifar100 --dataset cifar100 --pretraining DynACL++ --model r18 --checkpoint ./checkpoints/DynACL++_CIFAR100.pt --mode ALL --eval-AA --eval-OOD &
...
nohup python finetuning_eval.py --gpu 2 --experiment DynACL++_stl10_r18_stl10 --dataset stl10 --pretraining DynACL --model r18 --checkpoint ./checkpoints/DynACL++_STL10.pt --mode ALL --eval-AA &
