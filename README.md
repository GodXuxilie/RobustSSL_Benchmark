...
python finetuning_eval.py   --gpu GPU_id \
                            ...
                            --pretraining  pre_training_method: [ACL, AdvCL, A-InfoNCE, DeACL, DynACL, DynACL_IR, DynACL++_IR] \
...
In this section, robust pre-training and finetuning are conducted on the same datasets. 
...
Here, robust pre-training is conducted on CIFAR-10 and finetuning is conducted on STL10. 
...
Here, robust pre-training is conducted on CIFAR-100 and finetuning is conducted on STL10. 
