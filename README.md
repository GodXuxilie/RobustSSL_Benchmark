...
python finetuning_eval.py   --gpu GPU_id \
                            ...
                            --pretraining  pre_training_method: [ACL, AdvCL, A-InfoNCE, DeACL, DynACL, DynACL++, DynACL_IR, DynACL++_IR] \
...
In this section, robust pre-training, finetuning, and evaluation are conducted on the same datasets, including CIFAR-10, CIFAR-100, and STL10. 
