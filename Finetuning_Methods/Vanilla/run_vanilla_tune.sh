...
nohup python vanilla_finetuning.py --gpu 3 --experiment ACL_cifar10_r18_cifar10 --dataset cifar10 --pretraining ACL --model r18 --checkpoint ./checkpoints/ACL.pt --mode AFF --eval-AA --eval-OOD &
nohup python vanilla_finetuning.py --gpu 3 --experiment DynACL_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL --model r18 --checkpoint ./checkpoints/DynACL.pt --mode ALL --eval-AA --eval-OOD &
nohup python vanilla_finetuning.py --gpu 3 --experiment AdvCL_cifar10_r18_cifar10 --dataset cifar10 --pretraining AdvCL --model r18 --checkpoint ./checkpoints/AdvCL.pt --mode ALL --eval-AA --eval-OOD &
nohup python vanilla_finetuning.py --gpu 2 --experiment AInfoNCE_cifar10_r18_cifar10 --dataset cifar10 --pretraining A-InfoNCE --model r18 --checkpoint ./checkpoints/AInfoNCE.pt --mode ALL --eval-AA --eval-OOD &
nohup python vanilla_finetuning.py --gpu 2 --experiment DeACL_cifar10_r18_cifar10 --dataset cifar10 --pretraining DeACL --model r18 --checkpoint ./checkpoints/DeACL.pt --mode ALL --eval-AA --eval-OOD &
nohup python vanilla_finetuning.py --gpu 2 --experiment DynACL++_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL++ --model r18 --checkpoint ./checkpoints/DynACL++.pt --mode ALL --eval-AA --eval-OOD &
nohup python vanilla_finetuning.py --gpu 2 --experiment DynACL_IR_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL_IR --model r18 --checkpoint ./checkpoints/DynACL_IR.pt --mode ALL --eval-AA --eval-OOD &
nohup python vanilla_finetuning.py --gpu 2 --experiment DynACL++_IR_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL++_IR --model r18 --checkpoint ./checkpoints/DynACL++_IR.pt --mode ALL --eval-AA --eval-OOD &
