...
nohup python vanilla_finetuning.py --gpu 3 --experiment ACL_cifar10_r18_cifar10 --dataset cifar10 --pretraining ACL --model r18 --checkpoint /home/x/xuxilie/RobSSL_benchmark_copy/dropbox_checkpoints/ACL.pt --mode AFF --eval-AA --eval-OOD &
nohup python vanilla_finetuning.py --gpu 3 --experiment DynACL_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL --model r18 --checkpoint /home/x/xuxilie/RobSSL_benchmark_copy/dropbox_checkpoints/DynACL.pt --mode ALL --eval-AA --eval-OOD &
