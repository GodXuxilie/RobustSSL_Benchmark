...
python vanilla_finetuning.py --gpu 2 --experiment DynACL_AIR_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL-AIR --model r18 --checkpoint ./checkpoints/DynACL_AIR.pt --mode ALL --eval-AA --eval-OOD
python vanilla_finetuning.py --gpu 2 --experiment DynACL_AIR++_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL-AIR++ --model r18 --checkpoint ./checkpoints/DynACL_AIR++.pt --mode ALL --eval-AA --eval-OOD
python vanilla_finetuning.py --gpu 2 --experiment DynACL_RCS_cifar10_r18_cifar10 --dataset cifar10 --pretraining DynACL-RCS --model r18 --checkpoint ./checkpoints/DynACL_RCS.pt --mode ALL --eval-AA --eval-OOD
...
python vanilla_finetuning.py --gpu 2 --experiment DynACL_AIR_cifar100_r18_cifar100 --dataset cifar100 --pretraining DynACL-AIR --model r18 --checkpoint ./checkpoints/DynACL_AIR_CIFAR100.pt --mode ALL --eval-AA --eval-OOD
python vanilla_finetuning.py --gpu 2 --experiment DynACL_AIR++_cifar100_r18_cifar100 --dataset cifar100 --pretraining DynACL-AIR++ --model r18 --checkpoint ./checkpoints/DynACL_AIR++_CIFAR100.pt --mode ALL --eval-AA --eval-OOD
python vanilla_finetuning.py --gpu 2 --experiment DynACL_RCS_cifar100_r18_cifar100 --dataset cifar100 --pretraining DynACL-RCS --model r18 --checkpoint ./checkpoints/DynACL_RCS_CIFAR100.pt --mode ALL --eval-AA --eval-OOD
...
python vanilla_finetuning.py --gpu 2 --experiment DynACL_AIR_stl10_r18_stl10 --dataset stl10 --resize 96 --pretraining DynACL-AIR --model r18 --checkpoint ./checkpoints/DynACL_AIR_STL10.pt --mode ALL --eval-AA
python vanilla_finetuning.py --gpu 2 --experiment DynACL_AIR++_stl10_r18_stl10 --dataset stl10 --resize 96 --pretraining DynACL-AIR++ --model r18 --checkpoint ./checkpoints/DynACL_AIR++_STL10.pt --mode ALL --eval-AA
python vanilla_finetuning.py --gpu 2 --experiment DynACL_RCS_stl10_r18_stl10 --dataset stl10 --resize 96 --pretraining DynACL-RCS --model r18 --checkpoint ./checkpoints/DynACL_RCS_STL10.pt --mode ALL --eval-AA
...
python vanilla_finetuning.py --gpu 2 --experiment DynACL_AIR_cifar10_r18_stl10 --dataset stl10 --pretraining DynACL-AIR --model r18 --checkpoint ./checkpoints/DynACL_AIR.pt --mode ALL --eval-AA --dualBN 0
python vanilla_finetuning.py --gpu 2 --experiment DynACL_RCS_cifar10_r18_stl10 --dataset stl10 --pretraining DynACL-RCS --model r18 --checkpoint ./checkpoints/DynACL_RCS.pt --mode ALL --eval-AA --dualBN 0
...
python vanilla_finetuning.py --gpu 3 --experiment DynACL_AIR_cifar100_r18_stl10 --dataset stl10 --pretraining DynACL-AIR --model r18 --checkpoint ./checkpoints/DynACL_AIR_CIFAR100.pt  --mode ALL --eval-AA
